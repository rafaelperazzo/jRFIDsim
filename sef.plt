...
set ytics 0.01
set key default
plot '01_SEF.MOTA.4.5000.txt' using 1:2:3:4 with linespoint ls 1 title "Our NEDFSA System Efficiency simulation results", '01_SEF.MOTA.4.5000.txt' using 1:2:3:4 with errorbars ls 1 notitle
...
set ytics 500
set key default
plot '02_TOTAL.MOTA.4.5000.txt' using 1:2:3:4 with linespoint ls 1 title "NEDFSA Algorithm - Our simulation", '02_TOTAL.MOTA.4.5000.txt' using 1:2:3:4 with errorbars ls 1 notitle
